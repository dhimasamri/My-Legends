...
$nyoba2 = "SELECT * FROM postingan WHERE nama = '$nyb' ORDER BY id DESC";
...
<h5>Post</h5>
    ...
    <a style="border-radius: 20px; width: 15rem;" class="btn btn-primary" href="ubahakun.php?idakun=<?= $row["idakun"]; ?>">Edit Profil</a>
