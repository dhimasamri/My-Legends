    ...
    <div class="container d-flex justify-content-center p-4">
      ...
      <div class="card-body">
          ...
          <div class="d-flex">
            ...
            <a href="login.php">
            <button class="btn" type="submit" name="like" onclick="return confirm('harus login terlebih dahulu');">  
            <i class="far fa-heart pr-2" style="color:grey;"></i></button></a>
            <small class="pr-3"><?= count($like); ?></small>
            <a href="login.php">
            <button class="btn" onclick="return confirm('harus login terlebih dahulu');">
...
<div class="container d-flex justify-content-center">
  <form class="form">
    <div class="d-flex">
      <textarea class="form-control mr-2" rows="1" placeholder="Comment.."></textarea>
      <a href="login.php">
    <button class="btn btn-primary my-sm-0" type="button" onclick="return confirm('harus login terlebih dahulu');">Send</button></a>
  </div>
  </form>
  </div>
  <br>
